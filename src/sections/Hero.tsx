  ...
  return (
    <div className="bg-hero-img bg-cover bg-center bg-no-repeat h-[80vh]">
      <div className="h-full bg-gradient-to-tr from-green via-green/50 to-transparent">
        <div className="responsive h-full py-24 flex flex-col justify-end">
          <div className="h-auto w-[50vw]">
            ...
            <p className="text-white text-xl">
              At Vicwa Plumbing Supplies and Solutions, we pride ourselves on delivering quality solutions that ensure the
              seamless flow of water and waste systems.
            </p>
            <div className="py-4">
